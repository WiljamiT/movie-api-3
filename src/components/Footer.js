  ...
  return (
    ...
    <footer class="footer">
      ...
      <div class="footer-content">
        ...
        <div class="footer-content-column">
          <div class="footer-menu">
            <h2 class="footer-menu-name"> Text</h2>
        ...
        <div class="footer-content-column">
          <div class="footer-call-to-action">
            <h2 class="footer-call-to-action-title">Text</h2>
            <p class="footer-call-to-action-description">Text</p>
      ...
      <div class="footer-copyright">
        <div class="footer-copyright-wrapper">
          <p class="footer-copyright-text">
            <a class="footer-copyright-link" href="#" target="_self"> ©2023. | Wiljami Takkinen. </a>
          </p>
        </div>
      </div>
    </footer>
