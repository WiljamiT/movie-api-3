  ...
  return (
    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            <h2 className="footer-menu-name"> Text</h2>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title">Text</h2>
            <p className="footer-call-to-action-description">Text</p>
            <a className="footer-call-to-action-button button" href="_blank" target="/">Text</a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title">Call Us</h2>
            <i className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self"> 040 123 1234 </a></i>
          </div>
        </div>
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="_blank" target="/">
          ...
          <a className="footer-social-link twitter" href="_blank" target="/">
          ...
          <a className="footer-social-link youtube" href="_blank" target="/">
          ...
          <a className="footer-social-link github" href="_blank" target="/">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="_blank" target="/"> ©2023. | Wiljami Takkinen. </a>
          </p>
        </div>
      </div>
    </footer>
